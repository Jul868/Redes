        ...
        case '6': // Write Single Register
            ...
            if (ledCode == '0') {
                ...
                if (action == '0') {
                    ...
                    setupMPU9250(0x08, 0x00); // Configura el rango del giroscopio a ±500 grados/seg, y el rango del acelerómetro a ±4g
                    MPU9250_Res = 1;
                } else if (action == '2') {
                    setupMPU9250(0x10, 0x08); // Configura el rango del giroscopio a ±1000 grados/seg, y el rango del acelerómetro a ±8g
                    MPU9250_Res = 2;
                } else if (action == '3') {
                    setupMPU9250(0x18, 0x10); // Configura el rango del giroscopio a ±2000 grados/seg, y el rango del acelerómetro a ±16g
                    MPU9250_Res = 3;
                }
                actualizarVariablesEstado();
